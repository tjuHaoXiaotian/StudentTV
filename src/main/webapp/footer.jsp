...
<script src="<%=request.getContextPath()%>/bower_components/jquery-form/jquery.form.js"></script>

<script src="<%=request.getContextPath()%>/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
<script src="<%=request.getContextPath()%>/bower_components/datatables/media/js/dataTables.bootstrap.min.js"></script>
...
<!-- Graph JavaScript -->
<script src="<%=request.getContextPath()%>/js/d3.v3.js"></script>
<script src="<%=request.getContextPath()%>/js/rickshaw.js"></script>
...
//    $.ajax({
//        url: rootUrl+'mng/user/loginstatus',
//        type: 'get',
//        dataType: 'json'
//    })
//    .success(function(data){
//        if(data.state == 200 && data.data.loginstatus == true){
